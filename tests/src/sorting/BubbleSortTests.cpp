...
TEST(BubbleSort, SortsArrayOfLength1)
{
    int array[1] = { 316 };
    bubbleSort(array);
...
TEST(BubbleSort, SortsArrayOfLength10)
{
    // Arrange
...
TEST(BubbleSort, SortsSortedArray)
{
    // Arrange
...
TEST(BubbleSort, SortsReverseArray)
{
    // Arrange
...
TEST(BubbleSort, SortsArrayDescendingUsingComparator)
{
    // Arrange
    int array[] = { -328123, -555, 0, 22, 85, 55, 284, 316, 3912, 329111 };
    ...
    // Act
    bubbleSort(array, std::greater<int>());

    // Assert
    EXPECT_THAT(sorted, ElementsAreArray(array));
}

TEST(BubbleSort, SortsLettersInAscendingByDefault)
{
    // Arrange
...
TEST(BubbleSort, SortsVectorOfLength10)
{
    // Arrange
...
TEST(BubbleSort, SortsSortedVector)
{
    // Arrange
...
TEST(BubbleSort, SortsReverseVector)
{
    // Arrange
