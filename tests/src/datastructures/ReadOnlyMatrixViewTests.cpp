...
TYPED_TEST(ReadOnlyMatrixViewInitializationTests, InitializesToCorrectValues)
{
    ...
    const datastructures::ReadOnlyMatrixView<TypeParam> view(this->data.data(), this->size, this->rows, this->cols,
...
{
    EXPECT_THROW(const datastructures::ReadOnlyMatrixView<TypeParam> view(this->data.data(), this->size, 0, this->cols,
...
{
    EXPECT_THROW(const datastructures::ReadOnlyMatrixView<TypeParam> view(this->data.data(), this->size, this->rows, 0,
                                                                  this->rowBlock, this->colBlock, this->stride, true),
                 std::out_of_range);
}
...
{
    EXPECT_THROW(const datastructures::ReadOnlyMatrixView<TypeParam> view(this->data.data(), this->size, this->rows, this->cols,
...
{
    EXPECT_THROW(const datastructures::ReadOnlyMatrixView<TypeParam> view(this->data.data(), 0, this->rows, this->cols,
                                                                  this->rowBlock, this->colBlock, this->stride, true),
                 std::out_of_range);
}
...
{
    EXPECT_THROW(const datastructures::ReadOnlyMatrixView<TypeParam> view(this->data.data(), this->size, this->rows + 10,
...
{
    EXPECT_THROW(const datastructures::ReadOnlyMatrixView<TypeParam> view(this->data.data(), this->size, this->rows,
