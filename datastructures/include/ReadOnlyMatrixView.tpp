#pragma once
/**
 * @file ReadOnlyMatrixView.tpp
 * @author Alan Abraham P Kochumon
 * @date Created on: March 24, 2026
 *
 * @brief ReadOnlyMatrixView implementation.
 *        This file contains the implementation of member functions defined in ReadOnlyMatrixView.h.
 *
...
namespace datastructures
{
    ...
    template <Arithmetic T>
    constexpr ReadOnlyMatrixView<T> ReadOnlyMatrixView<T>::getSubview(const std::size_t rowBlock,
