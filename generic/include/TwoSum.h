...
namespace Algorithms::Generic
{
	 ...
	 * @return If two numbers add up to the target, they are returned in ascending order, else `std::nullopt` is returned. Not the first found elements are returned.
	 */
