 ...
 *
 * @brief Polynomial evaluation agorithm using Horner's rule.
 * @note Only supports C-style arrays and std::vector currently.
 *
...
namespace algorithms
{
     ...
     * Note: If you don't align elements, the sum will not be correct. That is for equation that 0 coefficient
     * polynomials, you must pass in the 0. EG: 2x^2 + 4x + 1 => {2, 4, 1} 4x^4 + 1 => {4, 0, 0, 0, 1}
