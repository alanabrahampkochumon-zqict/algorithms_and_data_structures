...
namespace algorithms
{
    ...
    {
        // Array needs to be sorted, since merge sort implementation is in place, it will mutate the array requiring a
        // temp array.
        T temp[Size];
        std::copy(std::begin(elements), std::end(elements), std::begin(temp));
        algorithms::mergeSort(temp);
